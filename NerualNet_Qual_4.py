...
df = df.drop(['log_level'], axis=1).drop(['lemmas'], axis=1).drop(['pos'], axis=1).drop(['tag'], axis=1).drop(['dep'], axis=1).drop(['alpha'], axis=1).drop(['stop'], axis=1)
print(df.head())
...
predicted, expected = evaluate(test_dataloader)
